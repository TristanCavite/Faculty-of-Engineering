 ...
 * - Shows the admin-edited Extra Section (about_sections.extra_section_2)
 * - Identical behavior to extra1.vue but points to extra_section_2
 */
...
// Reactive document reference for extra_section_2
const docRef = doc(db, 'admission_sections', 'extra_section_2')
